					...
					<div class="card card-body" style="margin-top:20px;">
						<div class="row" style="margin-bottom:20px;">
							<div class="col-md-12">
								...
								if ($kom['id_user'] < 0){
									echo $host.'assets/images/admin.png';
								}else
								if ($file == 401 || is_null($file['path'])){
									echo $host.'assets/images/unknown.jpg';
								}else{
									echo $host.decrypt_url($file['path']);
								}
								echo '" onerror="this.onerror=null;this.src='.$host.'\'assets/images/unknown.jpg\';" class="gambar-bulat float-left rounded-circle"/>
												...
												if ($like_kom['id_user'] < 0){
													...
													<table>
														<tr class="d-flex align-items-center">
															<td><div><img src="'.$host.'assets/images/admin.png" onerror="this.onerror=null;this.src=\''.$host.'assets/images/unknown.jpg\';" class="gambar-bulat float-left rounded-circle"/></div></td>
													...
													if ($siswa == 401){
														...
														<table>
															<tr class="d-flex align-items-center">
																<td><div><img src="'.$host.'assets/images/unknown.jpg" onerror="this.onerror=null;this.src=\''.$host.'assets/images/unknown.jpg\';" class="gambar-bulat float-left rounded-circle"/></div></td>
														...
														<table>
															<tr class="d-flex align-items-center">
																<td><div><img src="'.$host.decrypt_url($file['path']).'" onerror="this.onerror=null;this.src=\''.$host.'assets/images/unknown.jpg\';" class="gambar-bulat float-left rounded-circle"/></div></td>
